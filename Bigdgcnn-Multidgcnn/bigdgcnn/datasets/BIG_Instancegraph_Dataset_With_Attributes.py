...
class BIG_Instancegraph_Dataset_With_Attributes(InMemoryDataset):
    ...
    def process(self):
        ...
        data_list = [self._networkx_to_pytorch_graph(graph, label) for graph, label in tqdm(data, desc="Converting networkx graphs to PyG Graphs")] 
