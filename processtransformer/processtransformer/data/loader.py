...
class LogsDataLoader:
    def __init__(self, name, fold, dir_path = "./datasets"):
    ...
    def load_data(self, task):
        ...
        train_df = pd.read_csv(f"{self._dir_path}/{task.value}_{str(self._fold)}_train.csv")
        test_df = pd.read_csv(f"{self._dir_path}/{task.value}_{str(self._fold)}_test.csv")
